...
import { ReviewMarketingCreateController } from './interfaces/controllers/review.marketing.create.controller';
 ...
 * 营销评论校验商品复用 CommerceModule 导出的商品仓储端口。
...
@Module({
  ...
  controllers: [
    ...
    ReviewMarketingCreateController,

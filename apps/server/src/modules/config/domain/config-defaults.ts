...
export const DEFAULT_CONFIGS: ConfigDefault[] = [
  ...
  {
    key: CONFIG_KEYS.wallet.paymentWechatGateway,
    value: PaymentGateway.Official,
    type: ConfigValueType.String,
    group: ConfigGroup.Wallet,
  ...
  {
    key: CONFIG_KEYS.wallet.paymentAlipayGateway,
    value: PaymentGateway.Official,
    type: ConfigValueType.String,
    group: ConfigGroup.Wallet,
  ...
  {
    key: CONFIG_KEYS.wallet.jqfMchNo,
    value: '',
    type: ConfigValueType.String,
    group: ConfigGroup.Wallet,
    remark: '计全付商户号 mchNo',
  ...
  {
    key: CONFIG_KEYS.wallet.jqfAppId,
    value: '',
    type: ConfigValueType.String,
    group: ConfigGroup.Wallet,
    remark: '计全付应用 appId',
  ...
  {
    key: CONFIG_KEYS.wallet.jqfApiKey,
    value: '',
    type: ConfigValueType.String,
    group: ConfigGroup.Wallet,
